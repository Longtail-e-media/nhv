...
$slideRec = Module::find_properties_by($moduleId);
$settings = json_decode($slideRec);
            ...
            <form action="" class="col-md-12 center-margin" id="slideshow_frm">
                ...
                <div class="form-row add-image <?php echo !empty($imghide) ? $imghide : ''; ?>">
                    ...
                    <div class="form-input col-md-10 uploader1 <?php echo !empty($advInfo->image) ? "hide" : ""; ?>">
                        ...
                        <label>
                            <small>Image Dimensions For Main Slideshow
                                (<?php echo Module::get_properties($moduleId, 'imgwidth'); ?> px
                ...
                echo isset($_GET['id']) ? '' : 'hide'; ?> videolink">
                    ...
                    <?php if (!empty($advInfo->source)): ?>
                        <div class="col-md-3" id="removeSavedimg2">
                            <div class="infobox info-bg">
                                <div class="button-group" data-toggle="buttons">
                            <span class="word-break">
                                <?php
                                if (file_exists(SITE_ROOT . "images/slideshow/video/" . $advInfo->source)):
                                    $filesize = filesize(SITE_ROOT . "images/slideshow/video/" . $advInfo->source);
                                    echo '<p>' . $advInfo->source . '</p>';
                    ...
                    <?php endif; ?>
                    <div class="form-input col-md-10 uploader2 <?php echo !empty($advInfo->source) ? "hide" : ""; ?>">
                        <input type="file" name="vid_upload" id="vid_upload"
                               class="transparent no-shadow">
                        <label>
                            <small> Upload .mp4 files only</small>
                        </label>
                    </div>
                    <!-- Upload user image preview -->
                    <div id="preview_Video"><input type="hidden" name="videoArrayname"
                                                   value="<?php echo !empty($advInfo->source) ? $advInfo->source : ""; ?>"
                                                   class=""/></div>
                    <!--<div class="form-input col-md-10">
                        <input placeholder="http://www.youtube.com/watch?v=4GC0jGODGeY"
                               class="col-md-8 validate[custom[url]]"
